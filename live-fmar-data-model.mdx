...
description: "The current working entity-relationship model for the Flexibility Market Asset Register. Defines the entities, attributes, and relationships FMAR will hold as the GB flexibility market's authoritative system of record."
---

This page sets out the **working FMAR data model** — the entity-relationship view of what FMAR will hold as the authoritative system of record for GB flexibility market participants, assets, units, and qualifications.
...
- **If you're an observer of Flex World:** the cross-references at the end of each section show how FMAR concepts connect to FMRs, NESO procurement vocabulary, BSC settlement, and the adjacent CCS and DSI ecosystems.
