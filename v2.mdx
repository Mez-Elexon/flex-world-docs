...
>
> **Role.** A role designates the _set of responsibilities assumed_ by an actor within a specific process or context. A role is contextual, time-bound, process-specific, assignable, and revocable. An actor can hold multiple roles simultaneously, across assets and sub-markets.

In practice, this means a single Actor like **National Grid Electricity Distribution** can simultaneously be the Procuring System Operator for one Flexibility Asset, the Connecting System Operator for another, and a Market Operator (because NGED runs its own Market Gateway). Three roles, one actor — and FMAR has to know which role is acting at any moment.
...
flowchart LR
	...
	Comp{{"Market Bidding <br/>and Competition<br/>System"}}:::role
...
#### The Flexibility Service Provider depends on Qualification arrangements 

Flexibility Service Provider is an umbrella term used to refer to a family of Commercial Qualifications 
