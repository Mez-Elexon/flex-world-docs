...
**OpenADR** — international standard for issuing dispatch signals to flexible loads. Operational standard rather than a modelling reference, but informs the dispatch-side data structures. See [Standards](/reference/standards).
...
## How the references will evolve
